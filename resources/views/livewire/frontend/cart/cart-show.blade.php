                            ...
                            @if ($cartItem->product)
                                <div class="cart-item">
                                    <div class="row">
                                        ...
                                        <div class="col-md-1 col-7 my-auto">
                                        ...
                                        <div class="col-md-1 col-7 my-auto">
                                            @if ($cartItem->productSize)
                                                {{ $cartItem->productSize->size->name }}
                                            @else
                                                <div>No Size!</div>
                                            @endif
                                        </div>
            ...
            <div class="row">
                <div class="col-md-4 mt-3">
                    <div class="shadow-sm bg-white p-3">
                        ...
                        <hr>
                        <a href="{{ url('/checkout') }}" class="btn btn-warning w-100">Төлөлт хийх</a>
                    </div>
                </div>
            </div>
        </div>
